...
// const displayInfoElement = document.querySelector("#user-data button");
...
//     userInfo.textContent = `${propertyName}: ${dummyUserData[propertyName]}`

//     userData.appendChild(userInfo);
//     console.log(propertyName);
//     console.log(dummyUserData[propertyName]);
// }

// }

// displayInfoElement.addEventListener("click", displayInfo);
